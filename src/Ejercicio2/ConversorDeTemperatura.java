...
public class ConversorDeTemperatura extends javax.swing.JFrame {
    ...
    public ConversorDeTemperatura() {
        initComponents();
        bgBotones.add(botonFahren);
        bgBotones.add(botonKelvin);
        bgBotones.add(botonRadianes);
    }
    ...
    private void botonConvertirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonConvertirActionPerformed
        if (bgBotones.getSelection() == null) {
            JOptionPane.showMessageDialog(null, "Por favor, seleccione una opción de conversión.");
        }
        try {
